module.exports = (sequelize, DataTypes) => {
    return sequelize.define('Medication', {
        ...
        category: {
            type: DataTypes.ENUM('Anästhetika', 'Antibiotika', 'Antiparasitika', 'Augensalbe', 'Bronchienerweiterer', 'Ergänzungsfuttermittel', 'Entzündungshemmer', 'Salbe', 'Schleimlöser', 'Impfstoffe', 'Hormone', 'Vitamine', 'Sonstige'),
            allowNull: false,
