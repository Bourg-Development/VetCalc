module.exports = (sequelize, DataTypes) => {
    return sequelize.define('Medication', {
        ...
        category: {
            type: DataTypes.ENUM('Antibiotika', 'Antiparasitika', 'Augensalbe', 'Bronchienerweiterer', 'Ergenzungsfuttermittel','Salbe', 'Schleimlöser','Schmerzmittel', 'Impfstoffe', 'Hormone', 'Vitamine', 'Sonstige'),
            allowNull: false,
