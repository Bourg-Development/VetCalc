module.exports = (sequelize, DataTypes) => {
    return sequelize.define('Medication', {
        ...
        category: {
            type: DataTypes.ENUM('Anästhetika', 'Antibiotika', 'Antiparasitika', 'Antihistaminikum', 'Augensalbe', 'Bronchienerweiterer', 'Ergänzungsfuttermittel', 'Entzündungshemmer', 'Glucocorticoid','Salbe', 'Schleimlöser', 'Impfstoffe', 'Hormone', 'Vitamine', 'Sonstige'),
            allowNull: false,
